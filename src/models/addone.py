...
from .ngram_base import NGramLanguageModel

class AddOneSmoothedModel(NGramLanguageModel):
    """
    Implements Add-1 (Laplace) smoothing for N-gram language models.
    This model adds one to each N-gram count to avoid zero probabilities for unseen N-grams.
