...
class TextGenerator:
    ...
    def __init__(self, model):
        """
        Initialize the text generator with a language model.
        Args:
            model: The language model instance (must have vocab and get_probability).
        """
        self.model = model

    def generate_text(self, max_length: int = 50, start_tokens: List[str] = None) -> str:
        """
